...
//        test0();
    ...
    public static void test1() {
        ...
        System.out.println("第几周?-->>" + weekIndex);
        ...
        //2015/08/11  11:11;11
//        int unix = 1439262671;
//        cal.setTimeInMillis(unix*1000L);

        cal.set(Calendar.WEEK_OF_YEAR,33);
         weekIndex = cal.get(Calendar.WEEK_OF_YEAR);
        System.out.println("第几周2?-->>" + weekIndex);
        System.out.println("day2?-->>" + cal.get(Calendar.DAY_OF_MONTH));
         firstOfWeek = cal.getFirstDayOfWeek();
        System.out.println("firstOfWeek2?-->>" + firstOfWeek);
    }
